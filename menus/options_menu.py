...
class OptionsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("Speed", 44, self.mid_width - 48, self.mid_height + 38, text_format='tl')
            self.game.draw_text("Volume", 44, self.mid_width - 48, self.mid_height + 86, text_format='tl')
